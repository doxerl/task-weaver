      ...
      try {
        ...
        for (let fileIndex = 0; fileIndex < fileList.length; fileIndex++) {
          ...
          if (detectedCurrency !== 'TRY') {
            ...
            // EUR/USD fallback (approximate monthly TCMB averages; refine via Settings if needed)
            const EUR_FALLBACK: Record<string, number> = {
              // 2024
              '2024-1': 31.8, '2024-2': 33.3, '2024-3': 34.7, '2024-4': 34.5, '2024-5': 34.8, '2024-6': 34.7,
              '2024-7': 35.7, '2024-8': 37.0, '2024-9': 37.7, '2024-10': 37.2, '2024-11': 36.6, '2024-12': 36.9,
              // 2025
              '2025-1': 36.8, '2025-2': 37.7, '2025-3': 39.9, '2025-4': 43.1, '2025-5': 43.6, '2025-6': 45.3,
              '2025-7': 46.9, '2025-8': 47.4, '2025-9': 48.4, '2025-10': 48.5, '2025-11': 48.8, '2025-12': 49.5,
              // 2026
            ...
            const USD_FALLBACK: Record<string, number> = {
              // 2024
              '2024-1': 29.5, '2024-2': 30.8, '2024-3': 31.9, '2024-4': 32.3, '2024-5': 32.2, '2024-6': 32.4,
              '2024-7': 32.9, '2024-8': 33.6, '2024-9': 34.0, '2024-10': 34.3, '2024-11': 34.5, '2024-12': 35.2,
              // 2025
              '2025-1': 35.44, '2025-2': 36.07, '2025-3': 36.99, '2025-4': 38.01, '2025-5': 38.66, '2025-6': 39.33,
              '2025-7': 40.10, '2025-8': 40.73, '2025-9': 41.22, '2025-10': 41.73, '2025-11': 42.17, '2025-12': 42.58,
              // 2026
